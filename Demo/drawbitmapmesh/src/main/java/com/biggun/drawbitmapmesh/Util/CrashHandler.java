...
//                Toast.makeText(context, message, Toast.LENGTH_LONG).show();
                ...
                AlertDialog alertDialog = builder.setTitle("程序发生未知错误").setMessage("正在退出。。。").setPositiveButton("确定", new DialogInterface.OnClickListener()
                {
                    @Override
                ...
                alertDialog.getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_ALERT);//值得注意的一句话
                alertDialog.show();
                Looper.loop();
            }
        }.start();
