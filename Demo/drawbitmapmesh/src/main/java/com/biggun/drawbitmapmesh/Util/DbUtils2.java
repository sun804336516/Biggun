...
public class DbUtils2<T>
{
    ...
    {
        database = context.getApplicationContext().openOrCreateDatabase(SQLConstant.DATA_NAME, Context.MODE_PRIVATE, null);
        database.execSQL(String.format(SQLConstant.CREATETABLE_SQL, "normal"));
    }
...
//    SELECT count(*) FROM sqlite_master WHERE type='table' AND name='tableName';
    ...
    public boolean DataBaseisClose()
    {
        Utils.LogE("databaseopen:" + (database == null ? null : database.isOpen()));
