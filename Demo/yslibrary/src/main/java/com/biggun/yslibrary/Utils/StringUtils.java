...
//        }
    ...
    public static String getCacheFile(Context context, String cacheDirectory)
    {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            return context.getExternalCacheDir() + File.separator + cacheDirectory;
        }
        return context.getCacheDir() + File.separator + cacheDirectory;
    }
    ...
    public static void Readzhangjie(String text)
    {
        ...
        while (matcher.find()) {
            LogUtils.LogE("章节：" + matcher.group(0));
        }
    }
}
